  ...
  return (
    <PageLayout>
      <div className="inset-0 h-screen bg-brand flex justify-center items-center gap-4 p-2">
        <Button
          className="w-44 bg-accent text-white px-4 py-3 font-medium rounded-md"
                ...
                >
                  <form className="w-full flex flex-col gap-4 max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                    ...
                    <div className="flex justify-end gap-2">
                      <Button
                        className="w-auto bg-slate-400 text-white px-4 py-3 font-medium rounded-md"
        ...
        <Button
          className="w-44 bg-accent px-4 py-3 font-medium rounded-md"
